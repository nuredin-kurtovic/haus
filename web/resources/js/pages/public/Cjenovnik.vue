...
<template>
  <PublicLayout>
    <div class="container section-narrow">
      <h1 class="page-h1" style="margin-bottom:20px">Cjenovnik radova</h1>
      ...
      <section v-for="g in filteredCategories" :key="g.id" style="margin-bottom:48px">
        <h2 style="font-size:24px;font-weight:700;margin-bottom:14px">{{ g.name }}</h2>
      ...
      <div v-if="filteredCategories.length === 0" style="border:1px solid var(--sand);background:var(--ivory);padding:40px;margin-bottom:48px">
        <h2 style="font-size:22px;font-weight:600;margin-bottom:10px">Nema pozicije pod tim imenom</h2>
      ...
      <h2 style="font-size:24px;font-weight:700;margin-bottom:14px">Doplate</h2>
